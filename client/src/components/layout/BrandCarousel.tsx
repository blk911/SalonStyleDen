...
const carouselItems: CarouselCard[] = [
  ...
  {
    title: "",
    titleComponent: <><span className="logo logo-md"><span className="ven-me">Ven Me, </span><span className="baby">Baby!</span></span> <span className="font-serif">Gifting: Redefined!</span></>,
    content: [
