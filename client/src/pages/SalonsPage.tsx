                ...
                <div className="cursor-pointer" onClick={() => toggleCard(salon.id)}>
                  ...
                  {expandedCards[salon.id] && (
                    <>
                      ...
                      {/* Ven Me, Baby! Style Options - 2x2 Grid */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="border rounded px-2 py-2 border-pink-200 bg-pink-50">
                            <div className="flex">
                              ...
                              <div className="w-2/3 text-left pr-2">
                                <h3 className="font-medium text-compact">French Tips / Touch-Up</h3>
                                <p className="text-mini text-gray-600">Classic white tips or quick polish refresh.</p>
                                <div className="mt-1 flex items-center gap-2">
                                  <span className="font-bold text-compact">$40</span>
                          ...
                          <div className="border rounded px-2 py-2 border-pink-200 bg-pink-50">
                            <div className="flex">
                              {/* Left Side - Text */}
                              <div className="w-2/3 text-left pr-2">
                                <h3 className="font-medium text-compact">Luxe Gel Manicure</h3>
                                <p className="text-mini text-gray-600">Glossy, chip-free color with lasting shine.</p>
                                <div className="mt-1 flex items-center gap-2">
                                  <span className="font-bold text-compact">$55</span>
                          ...
                          <div className="border rounded px-2 py-2 border-pink-200 bg-pink-50">
                            <div className="flex">
                              {/* Left Side - Text */}
                              <div className="w-2/3 text-left pr-2">
                                <h3 className="font-medium text-compact">Sculpted Acrylics</h3>
                                <p className="text-mini text-gray-600">Custom-shaped acrylics for bold length.</p>
                                <div className="mt-1 flex items-center gap-2">
                                  <span className="font-bold text-compact">$70</span>
                          ...
                          <div className="border rounded px-2 py-2 border-pink-200 bg-pink-50">
                            <div className="flex">
                              {/* Left Side - Text */}
                              <div className="w-2/3 text-left pr-2">
                                <h3 className="font-medium text-compact">Glam Me! Custom Design</h3>
                                <p className="text-mini text-gray-600">Fully custom art, gems, 3D extras.</p>
                                <div className="mt-1 flex items-center gap-2">
                                  <span className="font-bold text-compact">$125+</span>
