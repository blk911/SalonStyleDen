  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section with Client Info - Simplified as requested */}
        <section className="bg-gradient-to-r from-pink-100 to-pink-50 py-6 border-b border-pink-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-start">
              ...
              {/* Client Info - Vertical Stack */}
              <div className="ml-8 flex flex-col">
                {/* Client Name */}
                <h1 className="font-bold text-2xl text-pink-800 mb-3">{client.name}</h1>
                ...
                {client.salonId && salon && (
                  <div className="flex flex-col mb-3">
                    ...
                    <span className="text-base font-semibold text-pink-800">{salon.name}</span>
                  </div>
                )}
